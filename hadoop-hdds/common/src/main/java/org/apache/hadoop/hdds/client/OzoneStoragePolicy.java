...
public enum OzoneStoragePolicy implements StoragePolicy {
  ...
  OzoneStoragePolicy(String name, StorageTier creationTier, StorageTier creationFallbackTier) {
    this.name = name;
  ...
  public StoragePolicyProto toProto() {
    ...
    default:
      throw new IllegalArgumentException("Error: StoragePolicyType not found, type=" + this);
    }
  }
  ...
  public static void setDefaultPolicy(OzoneStoragePolicy storagePolicy) {
    java.util.Objects.requireNonNull(storagePolicy);
