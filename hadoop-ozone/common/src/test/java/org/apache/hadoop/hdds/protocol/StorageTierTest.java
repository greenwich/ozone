...
class StorageTierTest {
  ...
  void testGetStorageTypesWithReplicationConfig() {
    ...
    ReplicationConfig standaloneOne = StandaloneReplicationConfig.getInstance(ONE);
    ReplicationConfig standaloneThree = StandaloneReplicationConfig.getInstance(THREE);
